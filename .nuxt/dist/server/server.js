...
/******/ 			var chunk = require("./" + ({"1":"components/answer-wait-post","2":"components/answer-wait-reply","3":"components/filtered-post","4":"components/new-post","5":"components/shared-send-sentence","6":"pages/_id","7":"pages/answer","8":"pages/index"}[chunkId]||chunkId) + ".js");
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  async holdPost(that, id, endPoint, key, boolean) {
    await that.$axios.$patch('https://q-box.microcms.io/api/v1/' + endPoint + '/' + id, {
      held: !boolean
    }, {
      headers: {
  ...
  generateImage(document, posts, mode, alphaId) {
    for (const post of posts) {
      var image = new Image();
      image.src = __webpack_require__(27);

      image.onload = function () {
        //画像ロードが完了してからキャンバスの準備をする
        var canvas = document.getElementById(post.id + alphaId);
        var ctx = canvas.getContext('2d'); //キャンバスのサイズを画像サイズに合わせる

        canvas.width = 600;
        canvas.height = 315; //キャンバスに画像を描画（開始位置0,0）
        ...
        ctx.drawImage(image, 0, 0, canvas.width, canvas.height); //文字のスタイルを指定

        ctx.font = '20px azuki';
        ctx.fillStyle = '#404040'; //文字の配置を指定（左上基準にしたければtop/leftだが、文字の中心座標を指定するのでcenter
...
module.exports = __webpack_require__.p + "img/frame.cf2009c.png";
...
__webpack_require__.d(components_namespaceObject, "AnswerWaitPost", function() { return AnswerWaitPost; });
__webpack_require__.d(components_namespaceObject, "AnswerWaitReply", function() { return AnswerWaitReply; });
__webpack_require__.d(components_namespaceObject, "FilteredPost", function() { return FilteredPost; });
__webpack_require__.d(components_namespaceObject, "NewPost", function() { return NewPost; });
__webpack_require__.d(components_namespaceObject, "SharedSendSentence", function() { return SharedSendSentence; });
...
async function setContext(app, context) {
  ...
  if (!app.context) {
    app.context = {
      ...
      env: {
        "MICROCMS_KEY": "f999ee3a5b064d859ee8072912dd0265ab9f",
        "CONSUMER_KEY": "Kn7JSGK3ebklzfZKsAgq8A6BB",
        "CONSUMER_KEY_SECRET": "Vsdsq0vosePrRgLbgVAMjco3Na4lFVQ8QiPUP3pwBp8gQG3lMe",
        "ACCESS_TOKEN_KEY": "1494570525166690304-hdloI9h9Vw27OZraElbtWL9GF6XPBm",
        "ACCESS_TOKEN_KEY_SECRET": "chgUBxGwAU3EI2njwyQXtXZZFw2tX7xAMdelA2zJuFBR3"
      }
    }; // Only set once
...
const _56cb4d28 = () => interopDefault(__webpack_require__.e(/* import() | pages/answer */ 7).then(__webpack_require__.bind(null, 69)));

const _0e9f9194 = () => interopDefault(__webpack_require__.e(/* import() | pages/index */ 8).then(__webpack_require__.bind(null, 70)));

const _3e4ce8fc = () => interopDefault(__webpack_require__.e(/* import() | pages/_id */ 6).then(__webpack_require__.bind(null, 71)));
...
const AnswerWaitPost = () => __webpack_require__.e(/* import() | components/answer-wait-post */ 1).then(__webpack_require__.bind(null, 54)).then(c => wrapFunctional(c.default || c));
const AnswerWaitReply = () => __webpack_require__.e(/* import() | components/answer-wait-reply */ 2).then(__webpack_require__.bind(null, 55)).then(c => wrapFunctional(c.default || c));
const FilteredPost = () => __webpack_require__.e(/* import() | components/filtered-post */ 3).then(__webpack_require__.bind(null, 47)).then(c => wrapFunctional(c.default || c));
const NewPost = () => __webpack_require__.e(/* import() | components/new-post */ 4).then(__webpack_require__.bind(null, 56)).then(c => wrapFunctional(c.default || c));
const SharedSendSentence = () => __webpack_require__.e(/* import() | components/shared-send-sentence */ 5).then(__webpack_require__.bind(null, 35)).then(c => wrapFunctional(c.default || c)); // nuxt/nuxt.js#8607
...
var vue_fontawesome_ = __webpack_require__(5);

// CONCATENATED MODULE: ./.nuxt/templates.plugin.4c3ec479.js



fontawesome_svg_core_["config"].autoAddCss = false;
external_vue_default.a.component('fa', vue_fontawesome_["FontAwesomeIcon"]);
external_vue_default.a.component('fa-layers', vue_fontawesome_["FontAwesomeLayers"]);
external_vue_default.a.component('fa-layers-text', vue_fontawesome_["FontAwesomeLayersText"]);
...
var external_vue_scrollto_ = __webpack_require__(17);
...
/* Plugins */
 ...
 // Source: ./templates.plugin.4c3ec479.js (mode: 'all')

 // Source: ./vue-scrollto.js (mode: 'client')

 // Source: ./axios.js (mode: 'all')

 // Source: ../plugins/common.js (mode: 'all')
...
async function createApp(ssrContext, config = {}) {
  ...
  const app = {
    head: {
      ...
      "meta": [{
        ...
        "hid": "og:image",
        "property": "og:image",
        "content": "https:\u002F\u002Fimages.microcms-assets.io\u002Fassets\u002Fca0c41f03efd472a910782fea07dff31\u002F24499c585ea7442b80644aa3f8237092\u002Fframe.png"
      }, {
        "name": "twitter:card",
  ...
  if (typeof /* Cannot get final name for export "default" in "./.nuxt/templates.plugin.4c3ec479.js" (known exports: , known reexports: ) */ undefined === 'function') {
    await /* Cannot get final name for export "default" in "./.nuxt/templates.plugin.4c3ec479.js" (known exports: , known reexports: ) */ undefined(app.context, inject);
  }
  ...
  if (typeof common["a" /* default */] === 'function') {
    await Object(common["a" /* default */])(app.context, inject);
  }
