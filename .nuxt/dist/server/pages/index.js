...
var add = __webpack_require__(7).default
module.exports.__inject__ = function (context) {
  add("53a8f8aa", content, true, context)
};
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_1_id_93398516_scoped_true_lang_scss___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(59);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_1_id_93398516_scoped_true_lang_scss___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_1_id_93398516_scoped_true_lang_scss___WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_1_id_93398516_scoped_true_lang_scss___WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_1_id_93398516_scoped_true_lang_scss___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
...
var ___CSS_LOADER_EXPORT___ = ___CSS_LOADER_API_IMPORT___(false);
// Module
___CSS_LOADER_EXPORT___.push([module.i, "header[data-v-93398516]{width:100%;height:70px;position:fixed;top:0;display:flex;justify-content:space-between;align-items:center;box-shadow:0 0 10px 5px rgba(0,0,0,.2);background-color:#fff;z-index:1000}header h1[data-v-93398516]{z-index:100;cursor:pointer}header .nuxt-link[data-v-93398516]{z-index:100;width:20%;height:100%;background-color:rgba(0,0,0,.1);display:flex;align-items:center;justify-content:center;color:#333;text-decoration:none;text-align:center;transition:.5s}header .nuxt-link[data-v-93398516]:hover{background-color:#303030;color:#fff}header input[data-v-93398516]{z-index:100;padding-left:10px;width:calc(20% - 10px);height:100%;background-color:rgba(0,0,0,.1);border:none;outline:none;font-size:1.2em;transition:.5s}header input[data-v-93398516]:focus{background-color:#303030;color:#fff}header .often-search-word-box[data-v-93398516]{transform-origin:center center;position:absolute;z-index:0;background-color:rgba(0,0,0,.8);top:100%;left:0;width:100%;max-height:200px;padding:10px;overflow:scroll;box-shadow:0 10px 10px 1px rgba(0,0,0,.2)}header .often-search-word-box h3[data-v-93398516]{margin:10px;color:#fff}header .often-search-word-box ul[data-v-93398516]{display:flex;flex-wrap:wrap;width:100%}header .often-search-word-box ul li[data-v-93398516]{list-style:none;width:11%;height:40px;display:flex;justify-content:center;align-items:center;border:1px solid #fff;color:#fff;border-radius:5px;margin:0 calc(.75% - 2.25px) 10px;cursor:pointer;transition:.5s;overflow:hidden}header .often-search-word-box ul li[data-v-93398516]:hover{background-color:#303030;color:#fff}.filtered-post[data-v-93398516],.new-post[data-v-93398516]{margin-top:70px}.v-enter[data-v-93398516]{opacity:0;transform:scale(90%)}.v-enter-to[data-v-93398516]{opacity:1;transform:scale(100%)}.v-enter-active[data-v-93398516]{transition:.2s}.v-leave[data-v-93398516]{opacity:1;transform:scale(100%)}.v-leave-to[data-v-93398516]{opacity:0;transform:scale(90%)}.v-leave-active[data-v-93398516]{transition:.2s}.chevron-up[data-v-93398516]{display:none}@media (max-width:520px){header[data-v-93398516]{height:60px}header h1[data-v-93398516]{display:none}header .nuxt-link[data-v-93398516]{width:50%}header input[data-v-93398516]{border-left:1px solid #303030;width:50%;padding-left:0;text-align:center}header .often-search-word-box[data-v-93398516]{padding:10px 5px 0}header .often-search-word-box ul li[data-v-93398516]{width:30%;margin:0 calc(1.66667% - 2.66667px) 10px}.chevron-up[data-v-93398516]{position:fixed;bottom:40px;right:30px;width:70px;height:70px;display:flex;justify-content:center;align-items:center;border-radius:50%;border:2px solid #fff;background-color:rgba(0,0,0,.6);color:#fff;font-size:2.2em}}", ""]);
// Exports
module.exports = ___CSS_LOADER_EXPORT___;
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/index.vue?vue&type=template&id=93398516&scoped=true&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{attrs:{"id":"app"}},[_vm._ssrNode("<header data-v-93398516>","</header>",[_c('nuxt-link',{staticClass:"nuxt-link",attrs:{"to":"/answer"}},[_vm._v("管理者画面に移動する")]),_vm._ssrNode(" "),_c('h1',{directives:[{name:"scroll-to",rawName:"v-scroll-to",value:({
      element: '#app',
      offset: -200,
      duration: 500
    }),expression:"{\n      element: '#app',\n      offset: -200,\n      duration: 500\n    }"}]},[_vm._ssrNode("お手サーの質問箱")]),_vm._ssrNode(" <input id=\"search-input\" type=\"text\" autocomplete=\"off\" placeholder=\"語句で検索\""+(_vm._ssrAttr("value",(_vm.qWord)))+" data-v-93398516> "),_c('transition',[_c('div',{directives:[{name:"show",rawName:"v-show",value:(_vm.showSearchWord && !_vm.qWord),expression:"showSearchWord && !qWord"}],staticClass:"often-search-word-box"},[_c('h3',[_vm._v("良く検索されるワード")]),_vm._v(" "),_c('ul',_vm._l((this.searchWords),function(word){return _c('li',{key:word,on:{"click":function($event){return _vm.inputSearchWord(word)}}},[_vm._v("\n            "+_vm._s(word)+"\n          ")])}),0)])])],2),_vm._ssrNode(" "),_vm._ssrNode("<div data-v-93398516>","</div>",[_c('NewPost',{directives:[{name:"show",rawName:"v-show",value:(_vm.showNewPost),expression:"showNewPost"}],staticClass:"new-post"}),_vm._ssrNode(" "),_c('FilteredPost',{directives:[{name:"show",rawName:"v-show",value:(_vm.showFilteredPost),expression:"showFilteredPost"}],ref:"FilteredPost",staticClass:"filtered-post"}),_vm._ssrNode(" "),_c('div',{directives:[{name:"scroll-to",rawName:"v-scroll-to",value:({
      element: '#app',
      offset: -200,
      duration: 500
...
// CONCATENATED MODULE: ./pages/index.vue?vue&type=template&id=93398516&scoped=true&
...
/* harmony default export */ var lib_vue_loader_options_pagesvue_type_script_lang_js_ = ({
  ...
  data() {
    return {
      ...
      searchWords: ['TOEFL', 'サークル', '般教', '一般教養１', 'バイト', '経営', '教育', '電情', '情報工']
    };
  },
